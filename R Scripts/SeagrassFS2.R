...
a <- c("Downloaded Future Env Layers", toString(layers_choice_sgfs))
...
a <- c("Downloaded Future Env Layers", toString(layers_choice_sgfs1))
metadata<-rbind(metadata, a)
...
a <- c("Downloaded Future Env Layers", toString(layers_choice_sgfs2))
metadata<-rbind(metadata, a)
