...
domain_mod_po <- dismo::domain(x = layers_mod_presonly[[vars_sel]], p = presence_centroids)  # presence-only
domain_mod <- dismo::domain(x = layers_mod[[vars_sel]], p = presence_centroids)
...
shrink <-  0.079   ## add number from above
